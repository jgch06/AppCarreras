...
--
/*!50003 DROP PROCEDURE IF EXISTS `agregarCarrera` */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `agregarCarrera`(IN `nombre` VARCHAR(200),  IN `escuela` VARCHAR(200), IN `imagen` VARCHAR(200))
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `crearSubSeccion`(IN `nombreCarrera` VARCHAR(200), IN `nombreSeccion` VARCHAR(200), IN `nombreSubSeccion` VARCHAR(200),  IN `descripcion` VARCHAR(200))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `crearSubSeccionVideo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `crearSubSeccionVideo`(IN `nombreCarrera` VARCHAR(200), IN `nombreSeccion` VARCHAR(200), IN `url` VARCHAR(200))
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `editarImagenSeccion`(IN `id` INT(11), IN `nombreSeccion` VARCHAR(200), IN `imagen` VARCHAR(200))
BEGIN

    UPDATE sections
    SET `image` = imagen
    WHERE career_idCareer = id  AND nombreSeccion = `name`;    
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `editarSeccionCarrera` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `editarSeccionCarrera`(IN `id` INT(11), IN `nombreSeccion` VARCHAR(200), IN `descripcion` TEXT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `editarSubSeccionCarrera` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `editarSubSeccionCarrera`(IN `id` INT(11), IN `nombreSeccion` VARCHAR(200), IN `nombreSubSeccion` VARCHAR(200), IN `descripcion` TEXT)
BEGIN

	DECLARE idSeccion INT(1);
    ...
    UPDATE subsections
    SET `description` = descripcion
    WHERE section_idSection = idSeccion  AND nombreSubSeccion = `name`;    
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `editarVideoCarrera` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `editarVideoCarrera`(IN `id` INT(11), IN `nombreSeccion` VARCHAR(200), IN `descripcion` TEXT)
BEGIN

	DECLARE idSeccion INT(2);
    ...
    SET `video_file_path` = descripcion
    WHERE section_IdSection = idSeccion;    
...
-- Dump completed on 2018-11-03 17:02:03
