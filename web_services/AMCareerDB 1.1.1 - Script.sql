...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`bd5a77700870d2`@`%` PROCEDURE `agregarVideoSeccion`(IN `idCarrera` INT(11), IN `nombreSeccion` VARCHAR(200), IN `url` VARCHAR(200))
BEGIN
...
-- Dump completed on 2018-11-12 23:28:51
